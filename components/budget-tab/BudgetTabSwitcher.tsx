...
export default function BudgetTabSwitcher({ tab, onTabChange }: BudgetTabSwitcherProps) {
    ...
    return (
        ...
        >
            ...
            >
                <Text style={{ textAlign: "center", color: colors.textPrimary, fontWeight: "600" }}>Expenses</Text>
            </Pressable>
            <Pressable
            ...
            >
                <Text style={{ textAlign: "center", color: colors.textPrimary, fontWeight: "600" }}>Income</Text>
            </Pressable>
        </View>
    );
}
